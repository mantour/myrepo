...
import os
execfile(os.path.join("hello", "release.py"))

packages=find_packages()
package_data = find_package_data(where='hello',
    package='hello')
...
setup(
    ...
    entry_points = {
        'console_scripts': [
            'start-hello = hello.command:start',
            # See the hello.command.bootstrap function for details
