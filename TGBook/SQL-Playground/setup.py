...
import os
execfile(os.path.join("sqlplayground", "release.py"))

packages=find_packages()
package_data = find_package_data(where='sqlplayground',
...
setup(
    ...
    entry_points = {
        'console_scripts': [
            'start-sqlplayground = sqlplayground.command:start',
            # See the sqlplayground.command.bootstrap function for details
