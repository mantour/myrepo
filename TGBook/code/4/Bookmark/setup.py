...
import os
execfile(os.path.join("bookmark", "release.py"))

packages=find_packages()
package_data = find_package_data(where='bookmark',
    package='bookmark')
...
setup(
    ...
    entry_points = {
        'console_scripts': [
            'start-bookmark = bookmark.command:start',
            # See the bookmark.command.bootstrap function for details
